...
public class EquipeController {
    ...
    @ApiOperation(value = "Retorna todos os equipes cadastradas")
    @GetMapping
    public ResponseEntity<List<Equipe>> obterTodos() {
        return new ResponseEntity<>(_equipeUsuario.obterTodos(), HttpStatus.OK);
    }

    @ApiOperation(value = "Filtra os equipes cadastrados de acordo com o Id")
    @GetMapping("/{id}")
    ...
    @ApiOperation(value = "Filtra os equipes cadastrados de acordo com o nome")
    ...
    @ApiOperation(value = "Cadastra um novo equipe")
    @PostMapping
    public ResponseEntity<Equipe> adicionar(@RequestBody Equipe equipe) {
        Equipe novoEquipe = _equipeUsuario.criarEquipe(equipe);
        return new ResponseEntity<>(novoEquipe, HttpStatus.CREATED);
    }

    @ApiOperation(value = "Atualiza as informações de um equipe de acordo com o id")
    @PutMapping("/{id}")
    ...
    @ApiOperation(value = "Deleta um equipe de acordo com o id")
    @DeleteMapping("/{id}")
